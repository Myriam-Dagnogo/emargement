...
if (isset($_POST['yes'])) {         
    $suprim=$bdd->prepare('DELETE FROM formation WHERE id_formation =?');
    $suprim->execute(array($ref));
    header('Location: views/insertFormation.php');
...
<body>
    ...
    <div class="container">
        <div class="disp-flex p-3 mt-5 bg-orange rounded-2">
            <h3>Voulez-vous vraiment retirer cette formation ?</h3 >
